...
Opinions on duress or decoy wallets differ. Some are [in favour](https://x.com/PixOnChain/status/1910070486907953553), others [less sure](https://blog.casa.io/can-duress-wallets-stop-bitcoin-attacks/). You might consider keeping a modest amount of crypto on your phone and **Personal** wallet unprotected by a passphrase to cover this.
...
If this is the sole method for your attorney or heirs to receive the **Static** passphrase, then it might make sense to use two **Legal** locations.
...
Don't leave your loved ones guessing what you left them or what they need to do. It is unlikely they're going to memorise pages of instructions, but perhaps point them at [Coinbase Learn](https://www.coinbase.com/learn) (or similar) in your letters.
...
<sup>*</sup> Keystone and AirGap Vault allow seed phrases to be generated by rolling dice or flipping coins. [Diceware](https://github.com/dstodolny/BIP39-diceware) is a command-line alternative for creating seed phrases with dice. Both can also hold and use multiple seedphrases. *So pick at least one of these.* The author will reference the Keystone for these functions as he has used one before.

| Image | Name | Features | Price |
|-------|------|----------|-------|
| ![Keystone 3 Pro](images/keystone-3-pro.jpg) | [Keystone 3 Pro](https://shop.keyst.one/products/keystone-3-pro)<sup>*</sup> | 4-inch touchscreen; air-gapped security; open-source firmware; supports multiple crypto accounts; compatible with MetaMask and other wallets. | $149.00 |
...
| ![AirGap Vault](images/airgap-vault.png) | [AirGap Vault](https://airgap.it/offline-device/)<sup>*</sup> | Free app for iOS/Android; air-gapped via QR codes; dice roll & coin flip entropy; Shamir social recovery; secure enclave storage with biometrics; supports BTC, ETH, DOT, XTZ, and more; open-source. | Free |
...
13. For each **Holding**:
	...
	2. Fund the address with suitable coins, usually ETH. Remember the funding source might identify the wallet to other people.
	...
	5. Reconfigure the Safe Vault for this holding to a 3/5 multisig. This will force you sign with all the wallets, so you know that they work.
14. **Wipe the two Guardian seedphrases/wallets from your Keystone.** (Keep the **Personal** one.)
15. You can now bag each of your backup plates in a tamper-proof bag. They'll have serial numbers on the seals — write them down in the notebook.
...
Have a glitter bomb in the decoy desk safe, install a quiet [panic button](https://www.deepsentinel.com/blogs/home-security/panic-buttons/?nab=1) in your home, or something 😄
...
1. Treat similarly to Personal passphrase loss for:
	...
	2. Home
	3. Offsite
2. Treat both Guardian wallets as a **Loss of Guardian** except you already have the friend.

## Variants

### Bitcoin only

Trezor and Keystone have Bitcoin-only firmware. You might also want to consider the Bitcoin-only [ColdCard wallet](https://coldcard.com). You might find [creating a multisig more challenging](https://medium.com/@1700constantino/protect-your-bitcoin-with-an-electrum-multi-sig-wallet-with-coldcard-ledger-and-trezor-96397e4ce287), but [Electrum wallet](https://electrum.org) software and a few others have offered this for a while. You should definitely read the [10x Bitcoin Security Guide](https://btcguide.github.io) and the [Glacier Protocol](https://glacierprotocol.org/).
...
- [10x Bitcoin Security Guide](https://btcguide.github.io) – The inspiration for this guide; covers multisig setup in depth.
- [Glacier Protocol](https://glacierprotocol.org/) – A thorough, step-by-step protocol for high-security Bitcoin storage.
- [Casa: Multisig Wallets](https://casa.io/learn-more/multisig-wallets) – Explains multisig concepts and Casa's approach to key distribution.
- [Unchained: Singlesig vs Multisig](https://www.unchained.com/features/singlesig-vs-multisig) – Compares single-key and multi-key approaches.
- [Unchained: Passphrase vs Multisig](https://www.unchained.com/blog/bitcoin-singlesig-passphrase-vs-multisig) – Trade-offs between passphrases and multisig.
- [Vault12: Seed Phrase Backup](https://vault12.com/learn/cryptocurrency-security-how-to/seed-phrase-backup/) – Best practices for backing up seed phrases.
- [Vault12: What is a Wallet Passphrase](https://vault12.com/learn/crypto-security-basics/what-is-a-wallet-passphrase/) – Explains passphrases and their risks.
- [Cypherock: Top 3 Methods to Backup Seed Phrase](https://www.cypherock.com/blogs/top-3-ways-to-backup-your-seed-phrases) – Practical backup methods.
- [BitPay: How to Store Your Seed Phrase](https://www.bitpay.com/blog/how-to-store-crypto-seed-phrase) – Security tips for seed phrase storage.
- [Hexn: How to Inherit Crypto](https://hexn.io/blog/how-to-inherit-crypto-hnej74smahqmus2wzo4ph7ik) – Practical crypto estate planning.
- [Bitcoin Magazine: Best Multisig Wallets](https://bitcoinmagazine.com/guides/best-multisig-wallets) – Overview of multisig wallet options.
- [Ledger: What's a Secret Recovery Phrase](https://www.ledger.com/academy/basic-basics/2-how-to-own-crypto/whats-a-secret-recovery-phrase) – Foundational knowledge on seed phrases.
